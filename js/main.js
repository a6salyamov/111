$(function () {
  ...
  $(".header__rate").rateYo("option", "normalFill", "#D7D1C7");
  $(".header__rate").rateYo("option", "ratedFill", "#FFB648");


  // =========== фильтр MIXITUP =================

  var mixer = mixitup('.blog__list');
  $('.blog__filter-button').on('click', function () {
    $('.blog__filter-button').removeClass('blog__filter-button--active')
    $(this).addClass('blog__filter-button--active')
  })
  ...
  $(".header__nav-list a, .header__button, .process__button, .cta__button-link, .footer__bottom-logo-link, .footer__bottom-nav-link").on("click", function (e) {
    e.preventDefault()
